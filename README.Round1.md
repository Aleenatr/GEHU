...
- **Zero-Cloud Architecture**: All computation occurs on-device; no external API calls or cloud fallbacks
- **Curriculum-Native RAG**: Responses synthesized exclusively from locally-stored NCERT textbooks using on-device retrieval pipelines
- **Constrained-Resource Optimization**: Functional AI assistance on 2-3GB RAM devices through quantized models and efficient TF-IDF retrieval
- **Deployment-Ready for Government Scale**: No infrastructure dependencies, respects data sovereignty, aligns with public education policy requirements

This represents a working implementation of NCERT-grounded conversational AI operating fully offline on resource-limited mobile devices—a configuration specifically designed for large-scale deployment in government schools lacking reliable connectivity.
...
<div align="center">
  <img src="docs/images/app_ss_1.jpg" width="250" alt="Home Screen"/>
  <img src="docs/images/app_ss_2.jpg" width="250" alt="Chat Interface"/>
  <img src="docs/images/app_ss_3.jpg" width="250" alt="Student Schedule"/> 
</div>
...
4. **On-Device Language Model**: Gemma-3-1B (Q3 quantized) generates grounded responses
...
- **AI Model**: Gemma-3-1B-Instruct Q3_K_L (GGUF)
...
_These are intentional for Round 1 to validate core offline AI feasibility._
...
- Secure login and user profiles with smart data syncing (stores locally until internet available)
- Multi-user support on shared devices
- Fully offline operation post-login
- Authentication data queued in local storage until sync
...
- Quantization from 4-bit to 3-bit for improved performance
- Reduced model size and faster inference
- Better memory efficiency on low-end devices

### 6. Visual Learning Tools

- Interactive mindmaps for concept visualization
- Subject-wise concept mapping
- Visual learning pathways

### 7. Smart Data Syncing

- Handles user authentication data persistence (stores locally until internet available)
- Intelligent synchronization when internet becomes available
- Offline-first with optional cloud backup
- Minimal data usage optimization
- Local storage queue for pending sync operations

### 8. Smart Streak Counter

- Intelligent study pattern detection
- Adaptive streak goals based on usage
...
│   │   └── CMakeLists.txt         Hidden
│   └── assets/
│       ├── ai_data/               # NCERT curriculum JSON (Hidden)
│       └── models/                # GGUF model
└── docs/
```
...
| **Geetika Saini**  | Data Researcher & AI Integration | Gathered NCERT curriculum data and integrated AI model into the app | [LinkedIn](https://www.linkedin.com/in/geetika-saini-a4466728a) |
